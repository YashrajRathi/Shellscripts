...
cd /home/yashraj/metrics-server && cp -r /home/yashraj/kubernetes/staging/src/k8s.io ./ && docker build -t metric_server:$docker_tag -f Dockerfile . 
...
docker cp /home/yashraj/metrics-server/metrics-server $containerID:/home/kube_binaries/metrics-server/metrics-server
rm /home/yashraj/metrics-server/metrics-server
