...
ls -t /home/username/kube_manifests | grep api | grep server | head -n 10
...
docker cp /home/username/kube_manifests/$target_manifest_file $containerID:/etc/kubernetes/manifests/kube-apiserver.yaml
